...
\begin{itemize}
\item     ccall((:callSparseAim ,"/tmp/AndersonMoore.jl/deps/libAndersonMoore.so"), Compat.Nothing,
\item \href{https://cmake.org/documentation/}{cmake documentation}
\item \href{https://juliadocs.github.io/Documenter.jl/stable/man/hosting/#Hosting-Documentation-1}{hosting documentation}
\item \href{https://github.com/JuliaPackaging/CMakeWrapper.jl}{cmakewrapper}
\item \href{https://stackoverflow.com/questions/12705562/using-cmake-with-fortran}{cmake}D
\item \href{https://docs.julialang.org/en/latest/manual/documentation/}{documentation}
...
Base.return\_types  returns possible return types for given function
